...
DROP TABLE IS NOT EXISTS PET_CATEGORIES;
CREATE TABLE IF NOT EXISTS PET_CATEGORIES (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255)
);
DROP TABLE IS NOT EXISTS PET_COLORS;
CREATE TABLE IF NOT EXISTS PET_COLORS (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255)
);
DROP TABLE IS NOT EXISTS PETS;
...
DROP TABLE IS NOT EXISTS TYPES CREATE TABLE IF NOT EXISTS TYPES (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255),
    idParent INT,
    FOREIGN KEY (idParent) REFERENCES TYPES(id)
);
DROP TABLE IS NOT EXISTS PET_TYPES CREATE TABLE IF NOT EXISTS PET_TYPES (
    id INT AUTO_INCREMENT PRIMARY KEY,
    idPet INT,
    idType INT,
...
DROP TABLE IS NOT EXISTS PET_PALS CREATE TABLE IF NOT EXISTS PET_PALS (
    id INT AUTO_INCREMENT PRIMARY KEY,
    idPet INT,
    idPal INT,
